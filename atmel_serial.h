...
#define     ATMEL_US_USMODE_LIN_MASTER      FIELD_PREP(ATMEL_US_USMODE, 10)
#define     ATMEL_US_USMODE_LIN_SLAVE       FIELD_PREP(ATMEL_US_USMODE, 11)
...
#define ATMEL_US_LINID		BIT(14) /* LIN ID sent or received */
#define ATMEL_US_LINTC		BIT(15) /* LIN Transfer status*/
...
#define ATMEL_US_LINBE		BIT(25) /* LIN BIT Error*/
#define ATMEL_US_LINISFE	BIT(26)	/* LIN Inconsisten Synch Field Error */
#define ATMEL_US_LINIPE		BIT(27) /* LIN Identifier Parity Error */
#define ATMEL_US_LINCE		BIT(28)	/* LIN Checksum Error*/
#define ATMEL_US_LINSNRE	BIT(29)	/* LIN Slave Not Responding Error */
#define ATMEL_US_LINSTE		BIT(30)	/* LIN Synch Tolerance Error */
#define ATMEL_US_LINHTE		BIT(31)	/* LIN Header Timeout Error */
...
#define ATMEL_US_LINMR		0x54	/* LIN Mode Register */
#define ATMEL_US_LINIR		0x58	/* LIN Identifier Register */
